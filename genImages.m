...
frame = 50; 
fname = ['.\2017-10-18-17-33-13_0\pcd_merged\merged_velodyne_points_frame_00' num2str(frame) '.pcd'];
disp(['Loading: ' fname]);

frameB = 75; 
fnameB = ['.\2017-10-18-17-33-13_0\pcd_merged\merged_velodyne_points_frame_00' num2str(frameB) '.pcd'];
disp(['Loading: ' fnameB]);
...
frame = 340;
fname = ['./2017-10-18-17-33-13_0/pcd_merged/merged_velodyne_points_frame_0' num2str(frame) '.pcd'];
disp(['Loading: ' fname]);
